...
@section('title', 'Crear Contrato - Empleado')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">
                        <i class="fas fa-file-contract-plus text-primary"></i>
                        Crear Nuevo Contrato
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('empleado.contratos.store') }}" method="POST">
                        @csrf
                                ...
                                <select class="form-control @error('client_id') is-invalid @enderror" 
                                    ...
                                    @foreach($clientes as $cliente)
                                        <option value="{{ $cliente->client_id }}" 
                                                {{ old('client_id') == $cliente->client_id ? 'selected' : '' }}>
                                ...
                                <select class="form-control @error('property_id') is-invalid @enderror" 
                                    ...
                                    @foreach($propiedades as $propiedad)
                                        <option value="{{ $propiedad->property_id }}" 
                                                {{ old('property_id') == $propiedad->property_id ? 'selected' : '' }}>
