            ...
            <tbody>
                @foreach($contratos as $contrato)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('empleado.contratos.edit', $contrato->contract_id) }}" class="btn btn-warning btn-sm">Editar</a>
                            <form action="{{ route('empleado.contratos.destroy', $contrato->contract_id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
