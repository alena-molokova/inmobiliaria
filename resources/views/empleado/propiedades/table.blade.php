            ...
            <tbody>
                @foreach($propiedades as $propiedad)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('empleado.propiedades.edit', $propiedad->property_id) }}" class="btn btn-warning btn-sm">Editar</a>
                            <form action="{{ route('empleado.propiedades.destroy', $propiedad->property_id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
